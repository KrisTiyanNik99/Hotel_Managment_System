...
public class UserConsoleInterface {
    ...
    private final UserManagerImpl userManagerImpl = new UserManagerImpl(userRepoService);
    ...
    private User login() {
        ...
        User user = userManagerImpl.login(username, password);
        ...
        while (user == null && !goToRegistration) {
            ...
            user = userManagerImpl.login(username, password);
    ...
    private User registration() {
        ...
        User user = userManagerImpl.register(username, password);
        while (user == null && !isValid(username, password)) {
            ...
            System.out.println("Fill your username: ");
            password = scanner.nextLine();
            user = userManagerImpl.register(username, password);
        }
